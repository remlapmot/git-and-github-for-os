...
- About merge conflicts [here](https://docs.github.com/en/github/collaborating-with-pull-requests/addressing-merge-conflicts/about-merge-conflicts)
...
- Go to our test repo [here](https://github.com/tp-test-org/test)  
```{r}
knitr::include_graphics("img/tp-test-org-test.png")
```  
1. On GitHub: clone the repo to your local machine
1. In GitHub Desktop: make a new branch and switch to it
1. In any text editor: 
    - create a new markdown file called `firstname-lastname.md`
    - add a sentence or two to the file about yourself
...
1. On GitHub: Open a pull request from your branch to the `main` branch  
    - Select a reviewer (Tom/Venexia/Elsie)
1. In your text editor and GitHub Desktop: Make any changes requested by the reviewer and add these to your PR  
    - Hopefully your pull request will then be merged
1. On GitHub: Delete the branch you made your pull request from
1. In GitHub Desktop: Pull down the updated master branch to your machine ... in a real workflow you would then make another new branch ...
