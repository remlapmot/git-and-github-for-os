...
* These can happen if e.g., you forget to pull down the latest changes from GitHub (I find easy to forget in the morning), or if you're working on a project and say Venexia makes a PR which is merged but you have changed a line/s of code which Venexia changed
* It is very easy to forget to pull down latest changes when reopening a project
...
1. In any text editor: 
    a. Create a new markdown file called `firstname-lastname.md`
