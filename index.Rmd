...
- Git is better described as a *content addressable filesystem* which translates to Git tracks the contents of the files in your repo
  - Git takes the SHA-1 hash of the contents of your files (when you tell it to)
...
- A Linux version of GitHub Desktop available from [here](https://github.com/shiftkey/desktop/)
...
- Amend/Edit pull request by modifying/adding commits on the branch from which you sent the PR

### Common erros

#### Forgetting to pull down the latest changes from GitHub

* Easy to forget to pull down latest changes when reopening a project
* Fix
  - Move your changes to a new branch
  - Pull down the changes on GitHub
  - Merge your changes into the relevant branch

#### Merge conflict

- A merge conflict occurs in a pull request when ...
