...
Of course there are many excellent guides to Git and GitHub online, e.g.,
...
- OpenSafely documentation [here](https://docs.opensafely.org/getting-started/)
...
- The `.git` folder
  ...
  - Here is the `.git` folder of a repo on my computer  
    ```{r}
